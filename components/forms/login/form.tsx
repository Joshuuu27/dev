    ...
    <form onSubmit={handleLogin} className="space-y-4">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/forgot-password" className="text-xs text-[#6B46C1] hover:text-[#5A3AA3] font-medium">
            Forgot password?
          </Link>
        </div>
        <div className="relative">
      ...
      <div className="relative py-3">
        ...
        <div className="relative flex justify-center">
          <span className="bg-white px-3 text-[11px] sm:text-xs text-slate-500 font-medium uppercase tracking-widest">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Button
          ...
          className="h-11 text-sm rounded-xl border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 text-slate-700 transition-colors"
        >
          <svg className="w-4 h-4 mr-1.5 shrink-0 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24">
