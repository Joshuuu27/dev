...
import { SOSAlert, getUserSOSAlertsViaAPI, deleteSOSAlertViaAPI } from "@/lib/services/SOSService";
...
export default function UserSOSAlertsPage() {
  ...
  const fetchAlerts = async () => {
    ...
    try {
      const data = await getUserSOSAlertsViaAPI(user.uid);
      setAlerts(data);
    } catch (error) {
  ...
  const handleDeleteAlert = async () => {
    ...
    try {
      setIsDeleting(true);
      await deleteSOSAlertViaAPI(selectedAlert.id);
